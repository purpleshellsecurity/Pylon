...
@pytest.mark.parametrize(
    "endpoint",
    [
        "https://contoso-aoai.openai.azure.com",
        "https://contoso-aoai.openai.azure.com/",
        ...
        "https://contoso-aoai.openai.azure.com/openai/deployments/gpt-4.1",
    ],
)
def test_any_form_of_the_endpoint_normalizes_to_the_v1_surface(endpoint):
    assert azure_v1_base_url(endpoint) == "https://contoso-aoai.openai.azure.com/openai/v1/"
