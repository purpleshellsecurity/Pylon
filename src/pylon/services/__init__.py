...
#
# Nothing else declares it, and nothing should. "Add a service" means: route
# its data plane or write down that it has none, judge its operations, and it
# appears. There is no list to remember.
